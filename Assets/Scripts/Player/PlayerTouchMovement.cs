...
//     version 1.4.2
//     from Assets/Scripts/Player/PlayerTouchMovement.inputactions
//
...
public partial class @PlayerTouchMovement : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Invisble"",
                    ""type"": ""Button"",
                    ""id"": ""f6d4c160-34f6-4c1e-a2a9-9e48aafe6f57"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""b011187b-9034-4053-a423-b1ed465e2377"",
                ...
                {
                    ""name"": """",
                    ""id"": ""298d01fb-dc7e-47f3-8676-cc1510c703cd"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_PlayerMain_Invisble = m_PlayerMain.FindAction("Invisble", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_PlayerMain_Invisble;
    public struct PlayerMainActions
    {
        ...
        public InputAction @Invisble => m_Wrapper.m_PlayerMain_Invisble;
        ...
        public void SetCallbacks(IPlayerMainActions instance)
        {
            if (m_Wrapper.m_PlayerMainActionsCallbackInterface != null)
            {
                ...
                @Invisble.started -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnInvisble;
                @Invisble.performed -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnInvisble;
                @Invisble.canceled -= m_Wrapper.m_PlayerMainActionsCallbackInterface.OnInvisble;
            }
            ...
            if (instance != null)
            {
                ...
                @Invisble.started += instance.OnInvisble;
                @Invisble.performed += instance.OnInvisble;
                @Invisble.canceled += instance.OnInvisble;
            }
        }
    }
    ...
    public interface IPlayerMainActions
    {
        ...
        void OnInvisble(InputAction.CallbackContext context);
    }
}
